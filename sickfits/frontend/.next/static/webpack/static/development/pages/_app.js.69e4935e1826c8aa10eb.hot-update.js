...
})(["position:relative;.count{display:block;position:relative;transition:all .4s;backface-visibility:hidden;}.count-enter{transform:rotateX(0.5turn);scale:4;}.count-enter-active{transform:rotateX(0);}.count-exit{top:0;position:absolute;transform:rotateX(0);}.cont-exit-active{transform:rotateX(0.5turn);scale:4;}"]);
...
//# sourceMappingURL=_app.js.69e4935e1826c8aa10eb.hot-update.js.map