...
})(["position:relative;.count{display:block;position:relative;transition:all .4s;backface-visibility:hidden;}.count-enter{transform:scale(4) rotateX(0.5turn);}.count-enter-active{transform:rotateX(0);}.count-exit{top:0;position:absolute;transform:rotateX(0);}.cont-exit-active{transform:scale(4) rotateX(0.5turn);}"]);
...
//# sourceMappingURL=_app.js.48c7ef4a89253b74ef22.hot-update.js.map