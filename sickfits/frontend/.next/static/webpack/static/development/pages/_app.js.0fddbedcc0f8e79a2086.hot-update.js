...
function (_React$Component) {
  ...
  function RemoveFromCart() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "update", function (cache, payload) {
      ...
      console.log(payload); // 2. remove that item from the cart

      var cartItemId = payload.data.removeFromCart; // 3. write it back to the cache 
    });
...
//# sourceMappingURL=_app.js.0fddbedcc0f8e79a2086.hot-update.js.map