...
})(["position:relative;.count{display:block;position:relative;transition:all 4s;backface-visibility:hidden;}.count-enter{transform:rotateX(0.5turn);}.count-enter-active{transform:rotateX(0);}.count-exit{top:0;position:absolute;transform:rotateX(0);}.cont-exit-active{transform:rotateX(0.5turn);}"]);
...
//# sourceMappingURL=_app.js.9db5f53ae3c6b663fcc5.hot-update.js.map